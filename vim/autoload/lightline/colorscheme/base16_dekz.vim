let s:base03 = [ '#655d5d', 233 ]
let s:base02 = [ '#585050', 236 ]
let s:base01 = [ '#292424', 239 ]
let s:base00 = [ '#1b1818', 242  ]
...
let g:lightline#colorscheme#base16_dekz#palette = lightline#colorscheme#flatten(s:p)
